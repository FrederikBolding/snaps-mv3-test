// Taken from https://github.com/MetaMask/snaps-skunkworks/tree/8fdd68da6c01ccf3c15c39cfe2bbd56d8e59e2a8/packages/execution-environments/src/common/lockdown
...
window.addEventListener("message", function (event) {
  ...
  const result = eval(`${event.data.request}*2`);
